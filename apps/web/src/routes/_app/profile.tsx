...
function ProfileDashboard() {
	...
	// Default resume info
	const defaultResumeId = useRootStore(
		(state) => state.resumeIndex.defaultResumeId,
	);
			...
			{!loadError && (
				<div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
					...
					<div className="lg:col-span-3 flex flex-col gap-6">
						...
						<div className="flex overflow-x-auto md:flex-wrap gap-2 border-b-2 border-border pb-3 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
							{tabs.map((tab) => {
								...
								return (
									<button
										...
										className={`shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-base font-heading text-sm border-2 border-border transition-all cursor-pointer ${
											isActive
											...
											<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
												...
												<div className="flex flex-col gap-1.5">
													...
													<Input
														...
														onChange={(e) =>
															updateField("candidate", "email", e.target.value)
														}
													/>
												</div>
												<div className="flex flex-col gap-1.5">
													...
													<Input
														...
														onChange={(e) =>
															updateField("candidate", "phone", e.target.value)
														}
													/>
												</div>
												<div className="flex flex-col gap-1.5">
