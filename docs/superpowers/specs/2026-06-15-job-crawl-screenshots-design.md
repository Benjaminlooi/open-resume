...
We want to capture full-page PNG screenshots of crawled job pages (on both success and failure) to debug rendering issues, such as CAPTCHA challenges or layout timeouts. The screenshot will be saved on disk, served via the backend Fastify API, and displayed in the frontend's backend job details dialog.
...
### 1. Configuration (`apps/backend`)

#### [config.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/config.ts)
...
#### [server.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/server.ts)
...
### 2. Playwright Scraper (`apps/backend`)

#### [playwright.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/extract/playwright.ts)
...
#### [crawl-queue.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/jobs/crawl-queue.ts)
...
### 3. API Endpoints (`apps/backend`)

#### [context.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/routes/context.ts)
- Add `screenshotsPath: string` to `JobRouteContext`.

#### [job-routes.ts](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/backend/src/routes/job-routes.ts)
...
#### [BackendJobDetailsDialog.tsx](file:///Users/ben/ghq/github.com/Benjaminlooi/resume-builder/.worktrees/job-application-ai-helper/apps/web/src/components/jobs/BackendJobDetailsDialog.tsx)
...
### Automated Tests
- Update unit tests in `apps/backend/src/extract/playwright.test.ts` or add tests in `apps/backend/src/server.test.ts` to assert that the screenshot route returns `404` for missing screenshots, and successfully serves a PNG image file when present.
...
- Delete the job and verify that the file is removed from `.open-resume-backend/screenshots/`.
